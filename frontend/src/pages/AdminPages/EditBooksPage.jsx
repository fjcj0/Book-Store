        ...
        <div className='h-screen'>
            ...
            <div className='my-5 max-w-7xl mx-auto bg-base-300 p-3 rounded-xl text-center'>
                <div className='grid grid-cols-4'>
                    <h1 className='font-bold font-poppins'>Picture</h1>
                    <h1 className='font-bold font-poppins'>Id</h1>
                ...
                <div className='my-5 grid grid-cols-4 gap-5'>
                    ...
                    <h1 className='text-center font-bold font-josefin text-orange-500'>100</h1>
